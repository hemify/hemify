...
interface IHemifyControl {
    ...
    /// @param token IERC20 token address supported or revoked.
    ...
    /// @param nft IERC721 token address supported or revoked.
    ...
    /// @param agg      Chainlink aggregator address on Ethereum mainnet.
    ...
    /// @param token IERC20 token.
    /// @return AggregatorV3Interface `AggregatorV3Interface` registered for `token`.
